...
/*
#cgo bn256 CFLAGS:-DMCLBN_FP_UNIT_SIZE=4 -DMCLBN_COMPILED_TIME_VAR=144 -DBLS_SWAP_G 
#cgo bn256 LDFLAGS:-lbls256 
#cgo bn384 CFLAGS:-DMCLBN_FP_UNIT_SIZE=6 -DMCLBN_COMPILED_TIME_VAR=166 -DBLS_SWAP_G 
...
func (pub *PublicKey) Add(rhs *PublicKey) {
	G1Add(&pub.v, &pub.v, &rhs.v)
}

// Set --
func (pub *PublicKey) Set(mpk []PublicKey, id *ID) error {
	// #nosec
	return G1EvaluatePolynomial(&pub.v, *(*[]G1)(unsafe.Pointer(&mpk)), &id.v)
}
